<h1 align="center"> Olá, eu sou <a href="https://linkedin.com/in/pedro-maurilio">Pedro Maurilio</a> 👋 </h1>
...
<details>
  ...
  🏢 **FullStack Developer** — SoftwareSul *(Set 2022 – Jun 2023)*<br>
  &nbsp;&nbsp;&nbsp;&nbsp;• Desenvolvimento de processos e sites customizados<br>
  &nbsp;&nbsp;&nbsp;&nbsp;• Gestão de atividades/sprints com metodologia DevOps | Stack: **Vue.js, Node.js, GitLab**<br><br>

  🏢 **Web Developer PL** — HiLab (Hi Technologies) *(Jul 2021 – Ago 2022)*<br>
  &nbsp;&nbsp;&nbsp;&nbsp;• Desenvolvimento de relatórios clínicos dinâmicos e manutenção de softwares de saúde<br>
  &nbsp;&nbsp;&nbsp;&nbsp;• Stack: **Vue.js, React, TypeScript, Java, Jenkins, GitLab**<br><br>
...
<details>
  ...
  ✨ [StudyNextJs](https://github.com/IBlackSirius/StudyNextJs) — Estudos e conceitos práticos com **Next.js 14**<br>
  ✨ [ecommerce-admin](https://github.com/IBlackSirius/ecommerce-admin) — Painel administrativo de e-commerce em **TypeScript**<br>
  ✨ [ecommerce-store](https://github.com/IBlackSirius/ecommerce-store) — Loja virtual integrada com o painel admin em **TypeScript**<br>
  ✨ [LegalSearchRobo](https://github.com/IBlackSirius/LegalSearchRobo) — Robô de busca jurídica em **JavaScript**<br>
  ✨ [BibliotecaAPI](https://github.com/IBlackSirius/BibliotecaAPI) — API de biblioteca desenvolvida em **C#**<br>
</details>
